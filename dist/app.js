(function () {
    ...
    class Header extends DivComponent {
      ...
      render() {
        ...
        this.el.innerHTML = `
            ...
            <img src="static/search.svg" alt="search of books">
            Search of books
            </a>
            <a class="menu__item" href="#favorites">
            <img src="static/shape.svg" alt="bookmark">
            Bookmarks
   ...
   <div class="card__info">
        <div class="card__tag">
        ${this.cardState.subject ? this.cardState.subject[0] : "Is not set"}
        </div>
    ...
    class FavoritesView extends AbstarctView {
       constructor(appState) {
            super();
            this.appState = appState;
    ...
    class Search extends DivComponent {
      ...
      render() {
        ...
        <button><img src="static/search-white.svg"/></button>
        `;
    ...
    class MainView extends AbstarctView {
      ...
      render() {
        const main = document.createElement("div");
        main.innerHTML = `
    <h1>Books is found: ${this.state.numFound}</h1>
    `;
